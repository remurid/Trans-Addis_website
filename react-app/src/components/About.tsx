...
const About: React.FC<AboutProps> = ({
  ...
  return (
    <section className="elementor-section elementor-top-section elementor-element elementor-element-6be6c142 elementor-section-full_width elementor-section-stretched elementor-section-height-default elementor-section-height-default" data-id="6be6c142" data-element_type="section" id="about" data-settings='{"stretch_section":"section-stretched"}'>
      <div className="elementor-container elementor-column-gap-no">
        <div className="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-4a33ed0c" data-id="4a33ed0c" data-element_type="column">
          <div className="elementor-widget-wrap elementor-element-populated">
            <div className="elementor-element elementor-element-5c3103ac elementor-widget elementor-widget-jetly-about" data-id="5c3103ac" data-element_type="widget" data-widget_type="jetly-about.default">
                    ...
                    <div className="row">
                      ...
                      <div className="col-xl-6">
                        <div className="about-three__right">
                            ...
                            {points.map((point, index) => (
                              <li key={index}>
                                <div className="about-three__points-icon icon-svg-large">
                                  <span aria-hidden="true" className={`fa ${point.icon}`}></span>
                                </div>
                          ...
                          <a href={buttonHref} className="thm-btn about-three__btn">{buttonText}</a>
                        </div>
                      </div>
                    </div>
                  </div>
