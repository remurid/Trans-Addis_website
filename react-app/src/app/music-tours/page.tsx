...
export default function MusicTours() {
  const menuItems = [
    { label: 'Home', href: '/' },
        ...
        <section className="page-header">
          ...
          <div className="container">
            <div className="page-header__inner">
              <h2>Specialized charters for music tours and entourage travel</h2>
              <p className="section-subtitle">Secure transport for artists, crew and equipment with customized schedules and cargo handling solutions.</p>
              <ul className="thm-breadcrumb list-unstyled">
                <li><a href="/">Home</a></li>
                <li><a href="/services">Services</a></li>
                <li><span>Music Tours</span></li>
              </ul>
            </div>
          </div>
        </section>
              ...
              <div className="col-xl-8 col-lg-7">
                <div className="service-details__left">
                  <div className="service-details__img">
                    <img src="/uploads/2023/01/service-details-5.jpg" alt="Music Tours" />
                  </div>
                  <div className="service-details__content">
                    <h3 className="service-details__title">Music Tours</h3>
                    <p className="service-details__text">
                      Keep the rhythm going with our specialized music tour charter services.
                      Whether you're an artist, band, or music industry professional, we understand
                      the unique demands of touring and provide seamless transportation solutions.
                    </p>
                    <p className="service-details__text">
                      From transporting musical equipment and instruments to accommodating large
                      entourages, our music tour services ensure your performance schedule stays
                      on track with reliable, comfortable air travel.
                    </p>
                  </div>
                  <div className="service-details__benefits">
                    <h3>Benefits Include:</h3>
                    <ul className="list-unstyled service-details__benefits-list">
                      <li><i className="fas fa-check"></i> Specialized cargo handling for musical equipment</li>
                      <li><i className="fas fa-check"></i> Flexible scheduling around performance times</li>
                      <li><i className="fas fa-check"></i> Large cabin aircraft for bands and crews</li>
                      <li><i className="fas fa-check"></i> Climate-controlled cargo compartments</li>
                      <li><i className="fas fa-check"></i> Priority boarding and customs clearance</li>
                      <li><i className="fas fa-check"></i> Entertainment systems and sound equipment</li>
                    </ul>
                  </div>
                </div>
              </div>
