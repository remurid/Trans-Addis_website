          ...
          <div className="container">
            ...
            <div className="row">
              {services.map((service, index) => (
                <div key={index} className="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay={`${(index % 3 + 1) * 100}ms`}>
                  <div className="services-one__single">
                    <div className="services-one__img">
                      <img decoding="async" src={service.image} alt={service.title} />
                    </div>
                    <div className="services-one__content">
                      <div className="services-one__title-box">
                        <span className="services-one__sub-title">{service.subTitle}</span>
