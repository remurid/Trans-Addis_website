        ...
        <section className="page-header">
          ...
          <div className="container">
            <div className="page-header__inner">
              <h2>Discreet, secure charters for high-profile clients</h2>
              <p className="section-subtitle">VIP ground handling, dedicated security coordination and strict confidentiality on every flight.</p>
