        ...
        <section className="page-header">
          ...
          <div className="container">
            <div className="page-header__inner">
              <h2>Charters built for sports teams and large groups</h2>
              <p className="section-subtitle">Specialized handling for equipment, large cabins for teams, and scheduling around event timetables.</p>
